...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.online, activity= discord.Game("배고파덕"))
...
async def 재생(ctx, *, msg):
    if not vc.is_playing():
        ...
        chromedriver_dir = "C:/Users/jiyoung/Documents/PythonWS/discordbot/chromedriver.exe"
...
bot.run('MTA0MjM3MTQ1ODY3Mzk1MDc3Mg.GMG-yI.6DGM5pdpQ9zD1O_zK6mE777JrnuPJ9-JTGVxfg')
